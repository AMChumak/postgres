...
extern Datum get_count_user_types(PG_FUNCTION_ARGS);
extern Datum get_field_type_by_path(PG_FUNCTION_ARGS);
extern Datum get_field_offset_in_struct(PG_FUNCTION_ARGS);
